...
from . import views
from .views import HodViews, StaffViews, StudentViews
...
urlpatterns = [
    ...
    path('doRegistrtation', views.doRegistrtation, name='doRegistrtation'),
    
    # url for students 
    path('student_home/', StudentViews.student_home, name='student_home'),
    path('student_view_attendance/', StudentViews.student_view_attendance, name='student_view_attend'),
    ...
    path('staff_take_attendance', StaffViews.staff_take_attendance, name = "staff_take_attandance"),
    ...
    path('add_course_save', views.add_course_save, name='add_course_save'),
    path('manage_course/', StaffViews.manage_course, name='manage_course'),
    ...
    path("add_session/", StaffViews.add_session, name="add_session"),
    ...
    path('edit_student/<studen_id>/', HodViews.edit_student, name='edit_student'),
