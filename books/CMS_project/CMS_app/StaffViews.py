...
def staff_feedback_save(request):
    ...
    def save_attendance_data(request):
        # Get Values From Staff Take Attendance form via AJAX (JS)
        # Use get list to access HTML array/ List Input data
        
        student_ids = request.POST.get('students_ids')
        ...
        try:
            # First Attendance Data is Saved on Attendance 
